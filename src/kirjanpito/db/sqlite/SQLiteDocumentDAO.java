...
/**
 * <code>SQLiteDocumentDAO</code>:n avulla voidaan lisätä, muokata ja
 * poistaa tositteita sekä hakea olemassa olevien tositteiden
 * tietoja.
 * 
 * @author Tommi Helineva
 */
public class SQLiteDocumentDAO extends SQLDocumentDAO {
	private SQLiteSession sess;
	
	public SQLiteDocumentDAO(SQLiteSession sess) {
		this.sess = sess;
	}
