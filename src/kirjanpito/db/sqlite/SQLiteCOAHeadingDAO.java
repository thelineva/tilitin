...
/**
 * <code>SQLiteCOAHeadingDAO</code>:n avulla voidaan lisätä, muokata ja
 * poistaa tilikartan otsikoita sekä hakea olemassa olevien otsikoiden
 * tietoja.
 * 
 * @author Tommi Helineva
 */
public class SQLiteCOAHeadingDAO extends SQLCOAHeadingDAO {
	private SQLiteSession sess;
	
	/**
	 * Luo <code>SQLiteCOAHeadingDAO</code>-olion, joka käyttää
	 * tietokantaistuntoa <code>sess</code>
	 * 
	 * @param sess tietokantaistunto
	 */
	public SQLiteCOAHeadingDAO(SQLiteSession sess) {
		this.sess = sess;
	}
