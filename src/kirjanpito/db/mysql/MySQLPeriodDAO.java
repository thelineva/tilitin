...
/**
 * <code>MySQLPeriodDAO</code>:n avulla voidaan lisätä, muokata ja
 * poistaa tilikausia sekä hakea olemassa olevien tilikausien
 * tietoja.
 * 
 * @author Tommi Helineva
 */
public class MySQLPeriodDAO extends SQLPeriodDAO {
	private MySQLSession sess;
	
	/**
	 * Luo <code>MySQLPeriodDAO</code>-olion, joka käyttää
	 * tietokantaistuntoa <code>sess</code>
	 * 
	 * @param sess tietokantaistunto
	 */
	public MySQLPeriodDAO(MySQLSession sess) {
		this.sess = sess;
	}
